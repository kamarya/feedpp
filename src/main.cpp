...
int main(void) {
  ...
  lemon.is(rsspp::rss_parser::validate_date("2008"), "2008", "validate year only");
  lemon.is(rsspp::rss_parser::validate_date("2008-12-30T13:03:15Z"), "2008-12-30T13:03:15Z", "validate with Z timezone");
  ...
  lemon.is(rsspp::rss_parser::to_rfc1123(t), "Wed, 31 Dec 2008 13:03:15 GMT", "rfc1123 conversion");
